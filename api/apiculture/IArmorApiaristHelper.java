...
public interface IArmorApiaristHelper {
	 ...
	 * @since Forestry 4.2
	 */
	boolean isArmorApiarist(ItemStack stack, LivingEntity entity, String cause, boolean doProtect);
	 ...
	 * @since Forestry 4.2
	 */
	int wearsItems(LivingEntity entity, String cause, boolean doProtect);
}

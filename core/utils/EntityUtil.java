...
public abstract class EntityUtil {
	@Nullable
	public static <E extends MobEntity> E spawnEntity(World world, Class<E> entityClass, double x, double y, double z) {
	...
	public static <E extends MobEntity> E spawnEntity(World world, E living, double x, double y, double z) {
	...
	@Nullable
	private static <E extends MobEntity> E createEntity(World world, Class<E> entityClass) {
